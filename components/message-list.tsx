...
export default function MessageList() {
  ...
  return (
    <div className='flex flex-col w-full mr-10 pt-8 h-screen'>
      ...
      <h1 className='text-5xl text-gray-800 font-bold pb-2'>Messages</h1>
      <div className='bg-white p-10 flex flex-col rounded-xl  w-full h-full'>
        <div className='flex bg-white rounded-xl mx-4 md:mx-auto w-full basis-11/12'>
